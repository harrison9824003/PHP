<div id="footer_nav">
	...
	<div class="now_div">
    	...
    	<span class="fn_btn btn_add"><a href="sale_page_add.php">新增</a></span>
        <span class="fn_btn btn_look"><a href="sale_page.php">查看</a></span>
        <span class="fn_btn btn_search"><a href="sale_page_search.php">收尋</a></span>
        <span class="fn_btn btn_record"><a href="saleRecord.php">紀錄</a></span>
    </div>
    <div>
